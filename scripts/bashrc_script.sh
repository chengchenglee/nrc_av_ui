...
alias runBatchValidation="~/projects/nrc_ws/src/nrc_sim/simpleator/sim_base/score_bagfiles_parallel.sh /srv/nfs/avdata/snapshot_data_do_not_delete/curated_snapshots/Mike 4 0 resim 0 Mike"
